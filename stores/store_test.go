...
func (suite *StoreTestSuite) TestMockStore() {
	...
	eSubList := []QSub{QSub{"ARGO", "sub1", "topic1", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub2", "topic2", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub3", "topic3", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub4", "topic4", 0, 0, "", "endpoint.foo", 1, 10, "linear", 300}}
	...
	store.InsertSub("ARGO", "subFresh", "topicFresh", 0, 10, "", 1, "linear", 300)
	...
	eSubList2 := []QSub{QSub{"ARGO", "sub1", "topic1", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub2", "topic2", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub3", "topic3", 0, 0, "", "", 1, 10, "linear", 300},
		QSub{"ARGO", "sub4", "topic4", 0, 0, "", "endpoint.foo", 1, 10, "linear", 300},
		QSub{"ARGO", "subFresh", "topicFresh", 0, 0, "", "", 1, 10, "linear", 300}}
